        ...
        <section id="about">
            ...
            <ul style="list-style: none;line-height: 40px;width: 1200px;font-size: 23px;">
                    ...
                    <li style="margin: 15px 0px;">Contact Information: &nbsp;&nbsp;&nbsp;<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Facebook_icon_2013.svg/640px-Facebook_icon_2013.svg.png"  
                        alt="facebook" style="height: 25px;"><a href="#" style="text-decoration: none;color: rgb(0, 0, 0);">&nbsp;&nbsp; Facebook</a> &nbsp;&nbsp;| 
                        &nbsp;&nbsp;<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/1024px-Instagram_icon.png"  
                        alt="facebook" style="height: 25px;"><a href="#" style="text-decoration: none;color: rgb(0, 0, 0);">&nbsp;&nbsp; Instagram</a> &nbsp;&nbsp;| 
                        &nbsp;&nbsp;<img src="https://pngset.com/images/whatsapp-logo-hd-whatsapp-background-symbol-text-clothing-apparel-transparent-png-671626.png"  
                        alt="facebook" style="height: 25px;">&nbsp;&nbsp;+970-599-999888</li>
                    <li>Finally, We would like to express our deep gratitude and appreciation for the amazing staff of Axsos Academy
                      for all the hard work and dedication invested in making us self sufficient Web-Developers, Thank you very much.</li>
            </ul>
        </section>
      </div>
</body>
